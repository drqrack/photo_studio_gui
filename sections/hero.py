...
def render():
    ...
    with ui.element("div").style("background-image: url('/assets/welcome.jpg')").classes("h-screen w-screen flex flex-col bg-cover bg-center justify-center items-center"):
        ...
        with ui.element("div").classes("text-white font-bold text-center"):
            ...
            ui.html("<h1>Family's Studio<h1>").classes("text-7xl")
